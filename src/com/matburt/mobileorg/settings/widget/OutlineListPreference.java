...
public class OutlineListPreference extends Preference implements ControllerReceiver<DataController> {
	...
	BaseAdapter adapter = new BaseAdapter() {
		...
		public View getView(final int pos, View view, ViewGroup root) {
			if (null == view) {
				...
				view = inflater.inflate(R.layout.outline_list_list_item, root, false);
			}
			TextView textView = (TextView) view.findViewById(R.id.outline_list_item_text);
			ImageButton removeButton = (ImageButton) view.findViewById(R.id.outline_list_item_remove_button);
	...
	protected void onBindView(View view) {
		...
		Button addButton = (Button) view.findViewById(R.id.outline_list_add_button);
	...
	private void editItem(int pos) {
		...
		((Activity)getContext()).startActivityForResult(intent, SELECT_OUTLINE);
	}
	...
	private void saveData() {
		...
		getSharedPreferences().edit().putString(getKey(), sb.toString()).commit();
		reloadData();
	}
	...
	class SelectOutlineDialog extends DialogFragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View v = inflater.inflate(R.layout.select_outline_dialog, container, false);
			return v;
		}
	}
